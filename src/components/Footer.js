  ...
  return (
    <>
      <div className="Prefooter">
        <div>
          ...
          <p>
            ...
            10-day replacement policy on mi.com
          </p>
        </div>
        <div>
          {shieldIcon}
          <p>
            <b>100% secure payments </b> <br /> Ww support Cards, Wallets,EMI
            and COD
          </p>
        </div>
        <div>
      ...
      <div className="footer">
        ...
        <div>
          <div>Chat with our Virtual AI Bot(27/7 Live Agent Support)</div>
