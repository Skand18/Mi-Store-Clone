...
const Navbar = () => {
  return (
    <div className="nav">
      <div className="logo">
        <a href="/">
          <img id="logoimage" src={packageInfo.logo} alt="" />
        </a>
      </div>

      <Link to="/Xaiomi Phones" className="navlinks ">
        Xaiomi Phones
      </Link>
      <a href="/Redmi Phones" className="navlinks ">
        Redmi Phones
      </a>
      <a href="/Tv" className="navlinks ">
        TV
      </a>
      <a href="/Laptop" className="navlinks ">
        Laptops
      </a>
